            ...
            <div class="form-body">
                <form autocomplete="off" wire:submit.prevent="save">
                    <div class="form-field">
                        ...
                        <div class="input">
                            <input type="text" id="name" wire:model.defer="sponsor.name">
                        </div>
                        @error('sponsor.name')
                    ...
                    <div class="form-field">
                        ...
                        <div class="input">
                            <input type="text" id="email" wire:model.defer="sponsor.email">
                        </div>
                        @error('sponsor.email')
                        <span class="form-error inline-block my-3 rounded-md bg-red-100 py-3 px-5 font-medium text-sm text-red-400">
                        {{ $message }}
                    ...
                    <div class="form-field h-auto">
                        ...
                        <div class="input">
                            <textarea type="text" id="description" wire:model.defer="sponsor.description" class="w-full inline-block min-h-24" >
                            </textarea>
                        </div>
                        @error('sponsor.description')
                        <span class="form-error inline-block my-3 rounded-md bg-red-100 py-3 px-5 font-medium text-sm text-red-400">
                        {{ $message }}
                    </span>
                        @enderror
